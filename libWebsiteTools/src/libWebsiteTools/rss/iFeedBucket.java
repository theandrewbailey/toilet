 ...
 * nothing too fancy here, doesn't manipulate space-time or anything like that, sorry
...
public interface iFeedBucket {
     ...
     * @param name how the feed is accessed in the URL ("peanutButter" will be accessible through /rss/peanutButter)
     * @param feed feed object to add
     */
    public void addFeed(String name, iFeed feed);

    /**
     * uses @Feed to extract the desired URL for the feed, and uses it to call addFeed(String, iFeed)
     * @param feed feed object to add
    ...
    /**
     * adds a RssFeed by class name
     * must have @Feed on the class, as addFeed(iFeed) is called
    ...
    /**
     * graciously removes a feed by class
     * uses @Feed to determine which to remove
