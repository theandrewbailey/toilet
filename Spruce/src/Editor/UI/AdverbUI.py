...
# Form implementation generated from reading ui file 'Adverb.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tAdv = QtGui.QLineEdit(Form)
        self.tAdv.setObjectName("tAdv")
        self.gridLayout.addWidget(self.tAdv, 0, 1, 1, 1)
        ...
        self.advSyl = QtGui.QSpinBox(Form)
        self.advSyl.setMaximumSize(QtCore.QSize(60, 16777215))
        self.advSyl.setObjectName("advSyl")
        self.gridLayout.addWidget(self.advSyl, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QtGui.QApplication.translate("Form", "Adverbs", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("Form", "Adverbs:", None, QtGui.QApplication.UnicodeUTF8))
        self.bRemove.setText(QtGui.QApplication.translate("Form", "Remove Entry", None, QtGui.QApplication.UnicodeUTF8))
        self.singularLabel_3.setText(QtGui.QApplication.translate("Form", "Adverb:", None, QtGui.QApplication.UnicodeUTF8))
