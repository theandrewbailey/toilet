...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tAdv.setObjectName(_fromUtf8("tAdv"))
        ...
        self.advSyl.setObjectName(_fromUtf8("advSyl"))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Adverbs", None))
        self.label_3.setText(_translate("Form", "Adverbs:", None))
        self.bRemove.setText(_translate("Form", "Remove Entry", None))
        self.singularLabel_3.setText(_translate("Form", "Adverb:", None))
