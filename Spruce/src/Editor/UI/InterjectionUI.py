...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tInterj.setObjectName("tInterj")
        ...
        self.interjSyl.setObjectName("interjSyl")
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QtGui.QApplication.translate("Form", "Interjections", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("Form", "Interjections;", None, QtGui.QApplication.UnicodeUTF8))
        self.bRemove.setText(QtGui.QApplication.translate("Form", "Remove Entry", None, QtGui.QApplication.UnicodeUTF8))
        self.singularLabel_3.setText(QtGui.QApplication.translate("Form", "Interjection:", None, QtGui.QApplication.UnicodeUTF8))
