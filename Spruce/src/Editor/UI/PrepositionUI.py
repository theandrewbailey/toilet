...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tPrep.setObjectName(_fromUtf8("tPrep"))
        ...
        self.prepSyl.setObjectName(_fromUtf8("prepSyl"))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Prepositions", None))
        self.label_3.setText(_translate("Form", "Prepositions:", None))
        self.bRemove.setText(_translate("Form", "Remove Entry", None))
        self.singularLabel_3.setText(_translate("Form", "Preposition:", None))
