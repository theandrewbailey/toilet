...
# Form implementation generated from reading ui file 'Preposition.ui'
#
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tPrep = QtGui.QLineEdit(Form)
        self.tPrep.setObjectName("tPrep")
        self.gridLayout.addWidget(self.tPrep, 0, 1, 1, 1)
        ...
        self.prepSyl = QtGui.QSpinBox(Form)
        self.prepSyl.setMaximumSize(QtCore.QSize(60, 16777215))
        self.prepSyl.setObjectName("prepSyl")
        self.gridLayout.addWidget(self.prepSyl, 1, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(QtGui.QApplication.translate("Form", "Prepositions", None, QtGui.QApplication.UnicodeUTF8))
        self.label_3.setText(QtGui.QApplication.translate("Form", "Prepositions:", None, QtGui.QApplication.UnicodeUTF8))
        self.bRemove.setText(QtGui.QApplication.translate("Form", "Remove Entry", None, QtGui.QApplication.UnicodeUTF8))
        self.singularLabel_3.setText(QtGui.QApplication.translate("Form", "Preposition:", None, QtGui.QApplication.UnicodeUTF8))
