...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.tAdj.setObjectName(_fromUtf8("tAdj"))
        ...
        self.adjSyl.setObjectName(_fromUtf8("adjSyl"))
    ...
    def retranslateUi(self, Form):
        Form.setWindowTitle(_translate("Form", "Adjectives", None))
        self.label_3.setText(_translate("Form", "Adjectives:", None))
        self.bRemove.setText(_translate("Form", "Remove Entry", None))
        self.singularLabel_3.setText(_translate("Form", "Adjective:", None))
