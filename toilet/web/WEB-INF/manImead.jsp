...
<form action="adminImead" method="post" class="adminform" accept-charset="UTF-8">
    ...
    <c:forEach items="${imeadProperties}" var="imeadProp"><h:button type="submit" id="action" value="save"><h:local key="page_save"/></h:button>
    ...
    <tr class="secondmin"><td>
        <h:textbox id="key${propCount}" label="" maxLength="250" labelNextLine="false" value="${prop.localizationPK.key}" required="true" valueMissing="${valueMissing}" patternMismatch="${patternMismatch}" />
        </td><td>
    ...
    <table>
        ...
        <c:forEach begin="${propCount}" end="${propCount+1}" var="newCount"><tr class="secondmin">
