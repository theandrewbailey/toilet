...
<form action="<h:local key="security_baseURL" locale=""/>content" method="POST" enctype="multipart/form-data" class="adminform adminContent" accept-charset="UTF-8">
...
<br/>
<form action="<h:local key="security_baseURL" locale=""/>adminContent" method="POST" class="adminform adminContent" accept-charset="UTF-8"><p>Current Content:</p>
