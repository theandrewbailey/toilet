...
CREATE TABLE IF NOT EXISTS tools.fileupload (filename character varying(1000) NOT NULL, atime timestamp with time zone NOT NULL, etag character(250) NOT NULL, filedata bytea NOT NULL, brdata bytea, gzipdata bytea, mimetype character varying(100) NOT NULL, url character varying(65000), CONSTRAINT fileupload_pk PRIMARY KEY (filename));
